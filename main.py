...
if __name__ == '__main__':
    ...
    # Download the model resnet50_coco_best_v2.1.0.h5 and save it in the working directory


    model_path = r'resnet50_coco_best_v2.1.0.h5'
    ...
    image = read_image_bgr(r'000000008021.jpg')
